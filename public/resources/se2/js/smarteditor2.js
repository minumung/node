/**    * SmartEditor2 NHN_Library:SE2.3.1.O9858:SmartEditor2.0-OpenSource    * @version 9858    */    
var nSE2Version = 9858;if(typeof window.nhn=='undefined') window.nhn = {};
...
//	iMinUndoInterval : 50,
	...
	$init : function(iframe){
		...
		this.sBlankPageURL = "/se2/smart_editor2_inputarea";
	...
	initIframe : function(){
		try {
			...
			if (sCSSBaseURI){
				...
				linkNode.href = '/resources/se2/css/smart_editor2_in.css';
...
==> { a : 1, c : 3 }
	...
	loadCSS : function(url, fnCallback){
		...
		elStyle.setAttribute("href", "/resources/se2/css/smart_editor2_items.css");
		if(fnCallback){
